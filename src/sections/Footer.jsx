export default function Footer() {
  return (
    <>
      <footer className="bg-dark text-sage py-10 border-t border-white/6 text-center">
        <div className="w-full max-w-[1180px] mx-auto px-5">
          <a href="#top" className="inline-flex items-center gap-3 justify-center mb-4">
            ...
            <span className="font-rubik font-black text-[1.1rem] text-primary">חיים שכאלה</span>
          </a>
